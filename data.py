...
def extend_dataset(dataset):
    ...
    print("X ex size: %d" %(len(X_extended)))
    print("Y ex size: %d" %(len(y_extended)))
    print("X ex shape:")
    ...
    print("final dataset size: %d" %(dataset.count))
    print("final X ex size: %d" %(len(X_extended)))
    print("final y ex size: %d" %(len(y_extended)))
    print("final X ex shape:")
    print(X_extended.shape)
    print("final y ex shape:") 
    print(y_extended.shape)   
